...
@WebServlet(name = "SubmitReservation", urlPatterns = {"/SubmitReservation"})
public class SubmitReservation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            pstmt = con.prepareStatement("INSERT INTO reservation VALUES(NULL, ?, ?, ?)");

            int package_id = Integer.parseInt(request.getParameter("p_id"));
            int client_id = Integer.parseInt(request.getParameter("c_id"));
